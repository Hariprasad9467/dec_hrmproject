...
class _PayslipScreenState extends State<PayslipScreen> {
  ...
  Future<int> fetchWorkingDays(String employeeId, int month, int year) async {
    var url = Uri.parse("$baseUrl/attendance/attendance/history/$employeeId");
  ...
  Future<void> _fetchPayslipDetails() async {
    ...
    final url = Uri.parse(
      '$baseUrl/payslip/get-payslip-details?employee_id=$employeeId&year=$selectedYear&month=$selectedMonth',
    );
