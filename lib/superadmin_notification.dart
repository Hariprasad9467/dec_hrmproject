...
import 'main.dart'; // ✅ Import main.dart to access apiBaseUrl
...
class _EmployeeNotificationsPageState
  ...
  Future<void> fetchNotifs() async {
    ...
    /*
    final uri = Uri.parse(
      //"https://deploy-hrm.onrender.com/notifications/$selectedMonth/${widget.empId}",
      "https://deploy-hrm.onrender.com/api/notifications/employee/${widget.empId}",
    );
    */
    try {
      ...
      await Future.wait([
        ...
        fetchPerformanceNotifications(), // Fetches performance
        fetchHolidayNotifications(), // ✅ This was missing
      ]);
    } catch (e) {
  ...
  Future<void> fetchSmsNotifications() async {
    final uri = Uri.parse(
      "$apiBaseUrl/api/notifications/employee/${widget.empId}?month=$selectedMonth&category=message",
    );
  ...
  Future<void> fetchPerformanceNotifications() async {
    final uri = Uri.parse(
      "$apiBaseUrl/api/notifications/performance/employee/$selectedMonth/${widget.empId}",
    );
    final resp = await http.get(uri);
  ...
  Future<void> fetchHolidayNotifications() async {
    final uri = Uri.parse(
      "$apiBaseUrl/api/notifications/holiday/employee/ALL?month=$selectedMonth", // This was the incorrect hardcoded URL.
    );
    final resp = await http.get(uri);
